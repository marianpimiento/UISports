...
//Párametro para tiempo de inactividad en segundos
$inactivo=60;
	...
	<body>
		...
		<div id="wrapper" >
			...
			<div id="menusecundario" >
				...
				<iframe name="iframe2" src="../Scripts/MSinicioUsuario.html"  marginwidth="0" marginheight="0" name="ventana_iframe2" border="0" frameborder="0" width="100%" height="100%">
